...
export const PayrollImportModal: React.FC<PayrollImportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white w-full max-w-2xl rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[95vh] animate-in zoom-in-95 duration-300">
        {/* Modal Header */}
        ...
        <div className="p-10 space-y-10 flex-1 overflow-y-auto">
          ...
          <div className="space-y-3">
            <label htmlFor="import-company" className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Company / Entity</label>
            <select 
              id="import-company"
              value={clientLabel}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-3">
              <label htmlFor="period-start" className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1 flex items-center gap-2">
            ...
            <div className="space-y-3">
              <label htmlFor="period-end" className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1 flex items-center gap-2">
            ...
            <div className="space-y-3">
              <label htmlFor="release-date" className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Release Date</label>
              <input 
                id="release-date"
                type="date" 
                value={releaseDate}
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Payload Source (PDF)</label>
            </div>
            <label className={`block ${allFieldsFilled ? 'cursor-pointer' : 'cursor-not-allowed'}`}>
              ...
              <div className={`w-full py-16 border-2 border-dashed rounded-3xl flex flex-col items-center justify-center gap-6 transition-all ${
                selectedFiles.length > 0
                  ? 'bg-green-50/50 border-green-200 text-green-600'
                  : allFieldsFilled
                    ? 'bg-gray-50 border-gray-100 text-gray-500 hover:border-primary hover:bg-white hover:shadow-2xl hover:shadow-primary/5'
        ...
        <div className="p-10 bg-gray-50 border-t border-gray-100">
          <button
            ...
            className="w-full py-6 bg-primary text-white rounded-2xl text-xs font-black uppercase tracking-[0.2em] shadow-2xl shadow-primary/30 hover:bg-primary-dark hover:-translate-y-1 transition-all active:translate-y-0 disabled:opacity-50 disabled:translate-y-0 disabled:shadow-none"
          >
            {uploading ? (
          ...
          <p className="text-[9px] font-black text-gray-500 text-center uppercase tracking-[0.2em] mt-6 flex items-center justify-center gap-2">
